...
public class quickAppLoanCreation extends Reporterwrapper {
	...
	public void enteringloandetails() {
		...
		driver.findElement(By.xpath("(//input[@id='PrimaryBorrower_FirstTimeHomeBuyer_FirstTimeHomeBuyer'])[2]/.."))
				.click();
		...
		loanpurposedd.selectByVisibleText("Purchase Loan");
		
		WebElement loantype = driver.findElement(By.id("Loan_LoanType_LoanType"));
		Select loantypedd = new Select(loantype);
		loantypedd.selectByVisibleText("Conventional");
		
		
		WebElement loanprogramdd = driver.findElement(By.id("Product_ProgramTypeAdmin_ProgramTypeAdmin"));
		Select loanprodd = new Select(loanprogramdd);
		loanprodd.selectByIndex(1);
		...
		wait.until(
				ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//div[@id='FilesummaryLoanNumber']/a"))));
		System.out.println("navigated to filesumamry page");

	}

	@Then("print generated loannumber")
	public void printloannumber() throws IOException {

		status = "pass";
		testcasename = "loancreatedusingquickapp";

		WebElement loannum = driver.findElement(By.xpath("//div[@id='div1003Header']//td[1]"));
		if (loannum.isDisplayed()) {
